...
public class TelaCarrinhoCamiseta3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Conjunto Puma - Branco e Azul");
        ...
        recebeImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/camiseta3.jpeg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCarrinhoCamiseta3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCarrinhoCamiseta3().setVisible(true);
            }
        });
    }
