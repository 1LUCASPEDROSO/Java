...
public class TelaCarrinhoCamiseta2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Conjunto adidas - vermelho e preto");
        ...
        recebeImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/camiseta2.jpeg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCarrinhoCamiseta2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCarrinhoCamiseta2().setVisible(true);
            }
        });
    }
