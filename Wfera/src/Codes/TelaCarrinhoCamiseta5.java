...
public class TelaCarrinhoCamiseta5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Camiseta Paris Saint Germain - Cinza");
        ...
        recebeImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/camiseta5.jpeg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCarrinhoCamiseta5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCarrinhoCamiseta5().setVisible(true);
            }
        });
    }
