...
public class TelaCarrinhoCamiseta8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Camiseta nike - Preta");
        ...
        recebeImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/camiseta8.jpeg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCarrinhoCamiseta8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCarrinhoCamiseta8().setVisible(true);
            }
        });
    }
