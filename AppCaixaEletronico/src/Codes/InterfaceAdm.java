...
public class InterfaceAdm extends javax.swing.JFrame {
    ...
    String email = "pedrosolucas1745@gmail.com";
    String senha = "1234";
    ColocrDinheiro CD = new ColocrDinheiro();
    
   private void VerificaLogin (String email,int senha){
   
   if (!JTextEmail.getText().equals(email)){
       do {
       JOptionPane.showInputDialog(null, "Email errado, digite novamente: ");
       } while (!JTextEmail.getText().equals(email));
   }
   else if (!jPasswordField1.getText().equals(senha)){
    do {
       JOptionPane.showInputDialog(null, "Semha  errada, digite novamente: ");
       } while (!jPasswordField1.getText().equals(senha));
   }
   
   else {CD.setVisible(true);}
   }
    /**
